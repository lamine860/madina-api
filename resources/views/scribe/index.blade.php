                ...
                <li class="tocify-item level-1" data-unique="panier">
                    <a href="#panier">Panier</a>
                                    ...
                                    <ul id="tocify-subheader-panier" class="tocify-subheader">
                                                    <li class="tocify-item level-2" data-unique="panier-articles">
                                <a href="#panier-articles">Articles</a>
                            </li>
                                                            <ul id="tocify-subheader-panier-articles" class="tocify-subheader">
                                                                            <li class="tocify-item level-3" data-unique="panier-GETapi-v1-cart">
                                            <a href="#panier-GETapi-v1-cart">GET api/v1/cart</a>
                                        </li>
                                                                            <li class="tocify-item level-3" data-unique="panier-POSTapi-v1-cart">
                                            <a href="#panier-POSTapi-v1-cart">POST api/v1/cart</a>
                                        </li>
                                                                            <li class="tocify-item level-3" data-unique="panier-PATCHapi-v1-cart-items--cart_item-">
                                            <a href="#panier-PATCHapi-v1-cart-items--cart_item-">PATCH api/v1/cart/items/{cart_item}</a>
                                        </li>
                                                                            <li class="tocify-item level-3" data-unique="panier-DELETEapi-v1-cart-items--cart_item-">
                                            <a href="#panier-DELETEapi-v1-cart-items--cart_item-">DELETE api/v1/cart/items/{cart_item}</a>
                                        </li>
                                                                    </ul>
                                                                        </ul>
                            </ul>
                    <ul id="tocify-header-liste-de-souhaits" class="tocify-header">
                <li class="tocify-item level-1" data-unique="liste-de-souhaits">
                    <a href="#liste-de-souhaits">Liste de souhaits</a>
                </li>
                                    <ul id="tocify-subheader-liste-de-souhaits" class="tocify-subheader">
                                                    <li class="tocify-item level-2" data-unique="liste-de-souhaits-articles">
                                <a href="#liste-de-souhaits-articles">Articles</a>
                            </li>
                                                            <ul id="tocify-subheader-liste-de-souhaits-articles" class="tocify-subheader">
                                                                            <li class="tocify-item level-3" data-unique="liste-de-souhaits-GETapi-v1-wishlist">
                                            <a href="#liste-de-souhaits-GETapi-v1-wishlist">GET api/v1/wishlist</a>
                                        </li>
                                                                            <li class="tocify-item level-3" data-unique="liste-de-souhaits-POSTapi-v1-wishlist">
                                            <a href="#liste-de-souhaits-POSTapi-v1-wishlist">POST api/v1/wishlist</a>
                                        </li>
                                                                            <li class="tocify-item level-3" data-unique="liste-de-souhaits-DELETEapi-v1-wishlist--id-">
                                            <a href="#liste-de-souhaits-DELETEapi-v1-wishlist--id-">DELETE api/v1/wishlist/{id}</a>
                                        </li>
                                                                    </ul>
                                                                        </ul>
                            </ul>
                ...
                <li class="tocify-item level-1" data-unique="commandes">
                    <a href="#commandes">Commandes</a>
                                    ...
                                    <ul id="tocify-subheader-commandes" class="tocify-subheader">
                                                    <li class="tocify-item level-2" data-unique="commandes-acheteur">
                                <a href="#commandes-acheteur">Acheteur</a>
                            </li>
                                                            <ul id="tocify-subheader-commandes-acheteur" class="tocify-subheader">
                                                                            <li class="tocify-item level-3" data-unique="commandes-GETapi-v1-orders">
                                            <a href="#commandes-GETapi-v1-orders">GET api/v1/orders</a>
                                        </li>
                                                                            <li class="tocify-item level-3" data-unique="commandes-GETapi-v1-orders--id-">
                                            <a href="#commandes-GETapi-v1-orders--id-">GET api/v1/orders/{id}</a>
                                        </li>
                                                                            <li class="tocify-item level-3" data-unique="commandes-POSTapi-v1-orders-checkout">
                                            <a href="#commandes-POSTapi-v1-orders-checkout">POST api/v1/orders/checkout</a>
                                        </li>
                                                                    </ul>
                                                                                <li class="tocify-item level-2" data-unique="commandes-administration">
                                <a href="#commandes-administration">Administration</a>
                            </li>
                                                            <ul id="tocify-subheader-commandes-administration" class="tocify-subheader">
                                                                            <li class="tocify-item level-3" data-unique="commandes-PATCHapi-v1-orders--order_id--status">
                                            <a href="#commandes-PATCHapi-v1-orders--order_id--status">PATCH api/v1/orders/{order_id}/status</a>
                                        </li>
                                                                    </ul>
                                                                                <li class="tocify-item level-2" data-unique="commandes-vendeur">
                                <a href="#commandes-vendeur">Vendeur</a>
                            </li>
                                                            <ul id="tocify-subheader-commandes-vendeur" class="tocify-subheader">
                                                                            <li class="tocify-item level-3" data-unique="commandes-GETapi-v1-shops--shop_id--orders">
                                            <a href="#commandes-GETapi-v1-shops--shop_id--orders">GET api/v1/shops/{shop_id}/orders</a>
                                        </li>
                                                                    </ul>
                                                                        </ul>
                            </ul>
                    <ul id="tocify-header-livraison" class="tocify-header">
                <li class="tocify-item level-1" data-unique="livraison">
                    <a href="#livraison">Livraison</a>
                </li>
                                    <ul id="tocify-subheader-livraison" class="tocify-subheader">
                                                    <li class="tocify-item level-2" data-unique="livraison-estimation">
                                <a href="#livraison-estimation">Estimation</a>
                            </li>
                                                            <ul id="tocify-subheader-livraison-estimation" class="tocify-subheader">
                                                                            <li class="tocify-item level-3" data-unique="livraison-GETapi-v1-shipping-options">
                                            <a href="#livraison-GETapi-v1-shipping-options">Retourne les options de livraison Kilora (tarifs et fenêtres indicatives) pour un quartier donné.</a>
                                        </li>
                                                                    </ul>
                                                                                <li class="tocify-item level-2" data-unique="livraison-verification-logistique">
                                <a href="#livraison-verification-logistique">Vérification logistique</a>
                            </li>
                                                            <ul id="tocify-subheader-livraison-verification-logistique" class="tocify-subheader">
                                                                            <li class="tocify-item level-3" data-unique="livraison-POSTapi-v1-shipments-verify-pickup">
                                            <a href="#livraison-POSTapi-v1-shipments-verify-pickup">Valide le retrait d’un colis par le vendeur (code sortie) pour une expédition Kilora.</a>
                                        </li>
                                                                            <li class="tocify-item level-3" data-unique="livraison-POSTapi-v1-shipments-verify-delivery">
                                            <a href="#livraison-POSTapi-v1-shipments-verify-delivery">Valide la livraison finale au client via le code de confirmation.</a>
                                        </li>
                                                                    </ul>
                                                                        </ul>
                            </ul>
                    <ul id="tocify-header-avis" class="tocify-header">
                <li class="tocify-item level-1" data-unique="avis">
                    <a href="#avis">Avis</a>
                </li>
                                    <ul id="tocify-subheader-avis" class="tocify-subheader">
                                                    <li class="tocify-item level-2" data-unique="avis-produits">
                                <a href="#avis-produits">Produits</a>
                            </li>
                                                            <ul id="tocify-subheader-avis-produits" class="tocify-subheader">
                                                                            <li class="tocify-item level-3" data-unique="avis-GETapi-v1-shops--shop_slug--products--product_slug--reviews">
                                            <a href="#avis-GETapi-v1-shops--shop_slug--products--product_slug--reviews">Liste paginée des avis publiés d’un produit.</a>
                                        </li>
                                                                    </ul>
                                                                                <li class="tocify-item level-2" data-unique="avis-commandes">
                                <a href="#avis-commandes">Commandes</a>
                            </li>
                                                            <ul id="tocify-subheader-avis-commandes" class="tocify-subheader">
                                                                            <li class="tocify-item level-3" data-unique="avis-GETapi-v1-orders--order_id--reviewable-items">
                                            <a href="#avis-GETapi-v1-orders--order_id--reviewable-items">Articles livrés de la commande encore sans avis.</a>
                                        </li>
                                                                            <li class="tocify-item level-3" data-unique="avis-POSTapi-v1-orders--order_id--items--orderItem_id--reviews">
                                            <a href="#avis-POSTapi-v1-orders--order_id--items--orderItem_id--reviews">Crée un avis pour un article de commande livré.</a>
                                        </li>
                                                                    </ul>
                                                                                <li class="tocify-item level-2" data-unique="avis-gestion">
                                <a href="#avis-gestion">Gestion</a>
                            </li>
                                                            <ul id="tocify-subheader-avis-gestion" class="tocify-subheader">
                                                                            <li class="tocify-item level-3" data-unique="avis-PATCHapi-v1-reviews--id-">
                                            <a href="#avis-PATCHapi-v1-reviews--id-">Met à jour un avis du client connecté.</a>
                                        </li>
                                                                            <li class="tocify-item level-3" data-unique="avis-DELETEapi-v1-reviews--id-">
                                            <a href="#avis-DELETEapi-v1-reviews--id-">Supprime un avis du client connecté.</a>
                                        </li>
                                                                    </ul>
                                                                        </ul>
                            </ul>
...
<div class="bash-example">
    ...
    --form "logo=@/tmp/phpGipGKg" </code></pre></div>
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Le fichier image du logo (Max 2Mo). Must be a file. Must not be greater than 2048 kilobytes. Example: <code>/tmp/phpGipGKg</code></p>
        </div>
        </form>
...
<div class="bash-example">
    ...
    "http://localhost:8000/api/v1/shops/16" \
    --header "Authorization: Bearer {YOUR_AUTH_KEY}" \
    --header "Content-Type: multipart/form-data" \
    --header "Accept: application/json" \
    --form "name=Kilora Tech Store"\
    ...
    --form "company_name=Kilora SARL"\
    --form "vat_number=RC-CON-2024-B-1234"\
    --form "logo=@/tmp/phplIalPg" </code></pre></div>
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Le fichier image du logo (Max 2Mo). Must be a file. Must not be greater than 2048 kilobytes. Example: <code>/tmp/phplIalPg</code></p>
        </div>
        </form>
...
<code class="language-json" style="max-height: 300px;">{
    &quot;message&quot;: &quot;No query results for model [Modules\\Catalog\\Models\\Category] architecto&quot;
}</code>
 </pre>
    </span>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost:8000/api/v1/shops/architecto/products" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost:8000/api/v1/shops/architecto/products"
);
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost:8000/api/v1/shops/architecto/products/architecto" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost:8000/api/v1/shops/architecto/products/architecto"
);
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request POST \
    "http://localhost:8000/api/v1/shops/16/products" \
    --header "Authorization: Bearer {YOUR_AUTH_KEY}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request PUT \
    "http://localhost:8000/api/v1/shops/16/products/architecto" \
    --header "Authorization: Bearer {YOUR_AUTH_KEY}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request DELETE \
    "http://localhost:8000/api/v1/shops/16/products/architecto?force=" \
    --header "Authorization: Bearer {YOUR_AUTH_KEY}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request POST \
    "http://localhost:8000/api/v1/shops/16/products/architecto/images" \
    --header "Authorization: Bearer {YOUR_AUTH_KEY}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request DELETE \
    "http://localhost:8000/api/v1/shops/16/products/architecto/images/16" \
    --header "Authorization: Bearer {YOUR_AUTH_KEY}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<p>Example: <code>16</code></p>
                ...
                <h1 id="panier">Panier</h1>
                        ...
                        <h2 id="panier-articles">Articles</h2>
                                                    <h2 id="panier-GETapi-v1-cart">GET api/v1/cart</h2>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="panier-POSTapi-v1-cart">POST api/v1/cart</h2>
...
<span id="example-requests-POSTapi-v1-cart">
<blockquote>Example request:</blockquote>
...
<span id="example-responses-POSTapi-v1-cart">
</span>
<span id="execution-results-POSTapi-v1-cart" hidden>
    <blockquote>Received response<span
                id="execution-response-status-POSTapi-v1-cart"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-POSTapi-v1-cart"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-POSTapi-v1-cart" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-POSTapi-v1-cart">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-POSTapi-v1-cart" data-method="POST"
      data-path="api/v1/cart"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('POSTapi-v1-cart', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-POSTapi-v1-cart"
                    onclick="tryItOut('POSTapi-v1-cart');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-v1-cart"
                    onclick="cancelTryOut('POSTapi-v1-cart');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-POSTapi-v1-cart"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="POSTapi-v1-cart"
               value="Bearer {YOUR_AUTH_KEY}"
               data-component="header">
    <br>
<p>Example: <code>Bearer {YOUR_AUTH_KEY}</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="POSTapi-v1-cart"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="POSTapi-v1-cart"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<p>Quantité souhaitée (≥ 1). Must be at least 1. Example: <code>2</code></p>
                    ...
                    <h2 id="panier-PATCHapi-v1-cart-items--cart_item-">PATCH api/v1/cart/items/{cart_item}</h2>
...
<span id="example-requests-PATCHapi-v1-cart-items--cart_item-">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request PATCH \
    "http://localhost:8000/api/v1/cart/items/architecto" \
    --header "Authorization: Bearer {YOUR_AUTH_KEY}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
...
<span id="example-responses-PATCHapi-v1-cart-items--cart_item-">
</span>
<span id="execution-results-PATCHapi-v1-cart-items--cart_item-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-PATCHapi-v1-cart-items--cart_item-"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-PATCHapi-v1-cart-items--cart_item-"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-PATCHapi-v1-cart-items--cart_item-" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-PATCHapi-v1-cart-items--cart_item-">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-PATCHapi-v1-cart-items--cart_item-" data-method="PATCH"
      data-path="api/v1/cart/items/{cart_item}"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('PATCHapi-v1-cart-items--cart_item-', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-PATCHapi-v1-cart-items--cart_item-"
                    onclick="tryItOut('PATCHapi-v1-cart-items--cart_item-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-PATCHapi-v1-cart-items--cart_item-"
                    onclick="cancelTryOut('PATCHapi-v1-cart-items--cart_item-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-PATCHapi-v1-cart-items--cart_item-"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-purple">PATCH</small>
            <b><code>api/v1/cart/items/{cart_item}</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Authorization</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="PATCHapi-v1-cart-items--cart_item-"
               value="Bearer {YOUR_AUTH_KEY}"
               data-component="header">
    <br>
<p>Example: <code>Bearer {YOUR_AUTH_KEY}</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="PATCHapi-v1-cart-items--cart_item-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="PATCHapi-v1-cart-items--cart_item-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
                        ...
                        <h4 class="fancy-heading-panel"><b>URL Parameters</b></h4>
                    <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>cart_item</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
 &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="cart_item"                data-endpoint="PATCHapi-v1-cart-items--cart_item-"
               value="architecto"
               data-component="url">
    <br>
...
<p>Nouvelle quantité pour la ligne (≥ 1). Must be at least 1. Example: <code>3</code></p>
                    ...
                    <h2 id="panier-DELETEapi-v1-cart-items--cart_item-">DELETE api/v1/cart/items/{cart_item}</h2>
...
<span id="example-requests-DELETEapi-v1-cart-items--cart_item-">
<blockquote>Example request:</blockquote>
...
<span id="example-responses-DELETEapi-v1-cart-items--cart_item-">
</span>
<span id="execution-results-DELETEapi-v1-cart-items--cart_item-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-DELETEapi-v1-cart-items--cart_item-"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-DELETEapi-v1-cart-items--cart_item-"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-DELETEapi-v1-cart-items--cart_item-" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-DELETEapi-v1-cart-items--cart_item-">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-DELETEapi-v1-cart-items--cart_item-" data-method="DELETE"
      data-path="api/v1/cart/items/{cart_item}"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('DELETEapi-v1-cart-items--cart_item-', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-DELETEapi-v1-cart-items--cart_item-"
                    onclick="tryItOut('DELETEapi-v1-cart-items--cart_item-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-DELETEapi-v1-cart-items--cart_item-"
                    onclick="cancelTryOut('DELETEapi-v1-cart-items--cart_item-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-DELETEapi-v1-cart-items--cart_item-"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="DELETEapi-v1-cart-items--cart_item-"
               value="Bearer {YOUR_AUTH_KEY}"
               data-component="header">
    <br>
<p>Example: <code>Bearer {YOUR_AUTH_KEY}</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="DELETEapi-v1-cart-items--cart_item-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="DELETEapi-v1-cart-items--cart_item-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="cart_item"                data-endpoint="DELETEapi-v1-cart-items--cart_item-"
               value="architecto"
               data-component="url">
    <br>
<p>Example: <code>architecto</code></p>
                ...
                <h1 id="liste-de-souhaits">Liste de souhaits</h1>

    

                        <h2 id="liste-de-souhaits-articles">Articles</h2>
                                                    <h2 id="liste-de-souhaits-GETapi-v1-wishlist">GET api/v1/wishlist</h2>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="liste-de-souhaits-POSTapi-v1-wishlist">POST api/v1/wishlist</h2>
...
<p>Identifiant de la variante produit à enregistrer en favori. The <code>id</code> of an existing record in the product_variants table. Example: <code>1</code></p>
                    ...
                    <h2 id="liste-de-souhaits-DELETEapi-v1-wishlist--id-">DELETE api/v1/wishlist/{id}</h2>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request DELETE \
    "http://localhost:8000/api/v1/wishlist/architecto" \
    --header "Authorization: Bearer {YOUR_AUTH_KEY}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="url">
    <br>
<p>The ID of the wishlist. Example: <code>architecto</code></p>
            </div>
                    </form>
                ...
                <h1 id="commandes">Commandes</h1>
                        ...
                        <h2 id="commandes-acheteur">Acheteur</h2>
                                                    <h2 id="commandes-GETapi-v1-orders">GET api/v1/orders</h2>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="commandes-GETapi-v1-orders--id-">GET api/v1/orders/{id}</h2>
...
<code class="language-json" style="max-height: 300px;">{
    &quot;message&quot;: &quot;The route api/v1/orders/architecto could not be found.&quot;
}</code>
 </pre>
    </span>
...
<p>The ID of the order. Example: <code>architecto</code></p>
                    ...
                    <h2 id="commandes-POSTapi-v1-orders-checkout">POST api/v1/orders/checkout</h2>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="POSTapi-v1-orders-checkout"
               value="Bearer {YOUR_AUTH_KEY}"
               data-component="header">
    <br>
<p>Example: <code>Bearer {YOUR_AUTH_KEY}</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="billing_address"                data-endpoint="POSTapi-v1-orders-checkout"
               value=""
               data-component="body">
    <br>
...
<p>Message libre pour le vendeur (optionnel). Must not be greater than 5000 characters. Example: <code>Livrer avant 18h si possible.</code></p>
                                ...
                                <h2 id="commandes-administration">Administration</h2>
                                                    <h2 id="commandes-PATCHapi-v1-orders--order_id--status">PATCH api/v1/orders/{order_id}/status</h2>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request PATCH \
    "http://localhost:8000/api/v1/orders/architecto/status" \
    --header "Authorization: Bearer {YOUR_AUTH_KEY}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="order_id"                data-endpoint="PATCHapi-v1-orders--order_id--status"
               value="architecto"
               data-component="url">
    <br>
<p>The ID of the order. Example: <code>architecto</code></p>
...
<ul style="list-style-type: square;"><li><code>pending</code></li> <li><code>paid</code></li> <li><code>processing</code></li> <li><code>shipped</code></li> <li><code>cancelled</code></li> <li><code>refunded</code></li></ul>
                                ...
                                <h2 id="commandes-vendeur">Vendeur</h2>
                                                    <h2 id="commandes-GETapi-v1-shops--shop_id--orders">GET api/v1/shops/{shop_id}/orders</h2>
...
<span id="example-requests-GETapi-v1-shops--shop_id--orders">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost:8000/api/v1/shops/16/orders" \
    --header "Authorization: Bearer {YOUR_AUTH_KEY}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost:8000/api/v1/shops/16/orders"
);
...
<span id="example-responses-GETapi-v1-shops--shop_id--orders">
            <blockquote>
            <p>Example response (401):</p>
        </blockquote>
                <details class="annotation">
...
<span id="execution-results-GETapi-v1-shops--shop_id--orders" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-v1-shops--shop_id--orders"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-v1-shops--shop_id--orders"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-v1-shops--shop_id--orders" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-v1-shops--shop_id--orders">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-v1-shops--shop_id--orders" data-method="GET"
      data-path="api/v1/shops/{shop_id}/orders"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-v1-shops--shop_id--orders', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-v1-shops--shop_id--orders"
                    onclick="tryItOut('GETapi-v1-shops--shop_id--orders');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-v1-shops--shop_id--orders"
                    onclick="cancelTryOut('GETapi-v1-shops--shop_id--orders');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-v1-shops--shop_id--orders"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-green">GET</small>
            <b><code>api/v1/shops/{shop_id}/orders</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Authorization</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="GETapi-v1-shops--shop_id--orders"
               value="Bearer {YOUR_AUTH_KEY}"
               data-component="header">
    <br>
<p>Example: <code>Bearer {YOUR_AUTH_KEY}</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-v1-shops--shop_id--orders"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-v1-shops--shop_id--orders"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="shop_id"                data-endpoint="GETapi-v1-shops--shop_id--orders"
               value="16"
               data-component="url">
    <br>
<p>The ID of the shop. Example: <code>16</code></p>
                ...
                <h1 id="livraison">Livraison</h1>

    <p>Estimation des tarifs et délais, vérification du retrait et de la livraison.
Les versements vendeurs (<code>pending</code> → <code>ready</code>) sont déclenchés lors des vérifications logistiques ;
voir aussi <code>PayoutService</code> dans le module Payouts.</p>

                        <h2 id="livraison-estimation">Estimation</h2>
                                                    <h2 id="livraison-GETapi-v1-shipping-options">Retourne les options de livraison Kilora (tarifs et fenêtres indicatives) pour un quartier donné.</h2>

<p>
<small class="badge badge-darkred">requires authentication</small>
</p>

<p>Sans <code>neighborhood_slug</code>, des délais conservateurs s’appliquent pour FLASH (150–240 min).
Les prix proviennent des tarifs en base (<code>FLASH</code>, <code>DIRECT</code>, <code>ECO</code>).</p>
...
<span id="example-responses-GETapi-v1-shipping-options">
            <blockquote>
            <p>Example response (200, Zone A (madina)):</p>
        </blockquote>
                <pre>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="GETapi-v1-shipping-options"
               value="Bearer {YOUR_AUTH_KEY}"
               data-component="header">
    <br>
<p>Example: <code>Bearer {YOUR_AUTH_KEY}</code></p>
...
<p>Autorisation : vendeur propriétaire de la boutique de l’expédition, ou administrateur.
Appel idempotent : un second appel avec le même code valide renvoie toujours 200.</p>
<p><strong>Versements vendeurs</strong> : si le transporteur a <code>payout_trigger = pickup</code> (Kilora Internal),
le versement de la boutique passe de <code>pending</code> à <code>ready</code>.</p>
...
<code class="language-json" style="max-height: 300px;">{
    ...
    &quot;shipment&quot;: {
        ...
        &quot;status&quot;: &quot;picked_up&quot;
            ...
            <blockquote>
            <p>Example response (403, Vendeur non autorisé):</p>
        </blockquote>
                <pre>
...
<code class="language-json" style="max-height: 300px;"></code>
            ...
            <blockquote>
            <p>Example response (422, Code sortie invalide):</p>
        </blockquote>
                <pre>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="POSTapi-v1-shipments-verify-pickup"
               value="Bearer {YOUR_AUTH_KEY}"
               data-component="header">
    <br>
<p>Example: <code>Bearer {YOUR_AUTH_KEY}</code></p>
...
<p>Code sortie (obligatoire pour Kilora, non utilisé en auto-livraison boutique). Must not be greater than 32 characters. Example: <code>ABC123</code></p>
                    ...
                    <h2 id="livraison-POSTapi-v1-shipments-verify-delivery">Valide la livraison finale au client via le code de confirmation.</h2>

<p>
<small class="badge badge-darkred">requires authentication</small>
</p>

<p><strong>Kilora</strong> : le colis doit être en statut <code>picked_up</code> avant la livraison.
<strong>Auto-livraison boutique</strong> : le pickup n’est pas requis ; seul ce endpoint libère le versement.</p>
<p><strong>Versements vendeurs</strong> : si le transporteur a <code>payout_trigger = delivery</code> (boutique),
le versement passe de <code>pending</code> à <code>ready</code>. Lorsque toutes les expéditions (hors annulées)
sont livrées, la commande passe en statut <code>shipped</code>.</p>
...
<code class="language-json" style="max-height: 300px;">{
    &quot;message&quot;: &quot;Livraison valid&eacute;e.&quot;,
    &quot;shipment&quot;: {
        &quot;id&quot;: 1,
        &quot;status&quot;: &quot;delivered&quot;
    }
...
<code class="language-json" style="max-height: 300px;"></code>
            ...
            <blockquote>
            <p>Example response (422, Pickup requis (Kilora)):</p>
        </blockquote>
                <pre>

<code class="language-json" style="max-height: 300px;">{
    &quot;message&quot;: &quot;Le colis doit &ecirc;tre retir&eacute; (pickup) avant la livraison finale.&quot;,
    &quot;errors&quot;: {
        &quot;shipment_id&quot;: [
            &quot;Le colis doit &ecirc;tre retir&eacute; (pickup) avant la livraison finale.&quot;
        ]
    }
}</code>
 </pre>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="POSTapi-v1-shipments-verify-delivery"
               value="Bearer {YOUR_AUTH_KEY}"
               data-component="header">
    <br>
<p>Example: <code>Bearer {YOUR_AUTH_KEY}</code></p>
...
<p>Code de confirmation remis au client. Must not be greater than 32 characters. Example: <code>XYZ789</code></p>
                ...
                <h1 id="avis">Avis</h1>
                        ...
                        <h2 id="avis-produits">Produits</h2>
                                                    <h2 id="avis-GETapi-v1-shops--shop_slug--products--product_slug--reviews">Liste paginée des avis publiés d’un produit.</h2>
...
<span id="example-requests-GETapi-v1-shops--shop_slug--products--product_slug--reviews">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost:8000/api/v1/shops/architecto/products/architecto/reviews" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost:8000/api/v1/shops/architecto/products/architecto/reviews"
);
...
<span id="example-responses-GETapi-v1-shops--shop_slug--products--product_slug--reviews">
            <blockquote>
            <p>Example response (404):</p>
        </blockquote>
                <details class="annotation">
...
<span id="execution-results-GETapi-v1-shops--shop_slug--products--product_slug--reviews" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-v1-shops--shop_slug--products--product_slug--reviews"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-v1-shops--shop_slug--products--product_slug--reviews"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-v1-shops--shop_slug--products--product_slug--reviews" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-v1-shops--shop_slug--products--product_slug--reviews">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-v1-shops--shop_slug--products--product_slug--reviews" data-method="GET"
      data-path="api/v1/shops/{shop_slug}/products/{product_slug}/reviews"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-v1-shops--shop_slug--products--product_slug--reviews', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-v1-shops--shop_slug--products--product_slug--reviews"
                    onclick="tryItOut('GETapi-v1-shops--shop_slug--products--product_slug--reviews');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-v1-shops--shop_slug--products--product_slug--reviews"
                    onclick="cancelTryOut('GETapi-v1-shops--shop_slug--products--product_slug--reviews');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-v1-shops--shop_slug--products--product_slug--reviews"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-green">GET</small>
            <b><code>api/v1/shops/{shop_slug}/products/{product_slug}/reviews</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-v1-shops--shop_slug--products--product_slug--reviews"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-v1-shops--shop_slug--products--product_slug--reviews"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="shop_slug"                data-endpoint="GETapi-v1-shops--shop_slug--products--product_slug--reviews"
               value="architecto"
               data-component="url">
    <br>
<p>The slug of the shop. Example: <code>architecto</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="product_slug"                data-endpoint="GETapi-v1-shops--shop_slug--products--product_slug--reviews"
               value="architecto"
               data-component="url">
    <br>
<p>The slug of the product. Example: <code>architecto</code></p>
                                ...
                                <h2 id="avis-commandes">Commandes</h2>
                                                    <h2 id="avis-GETapi-v1-orders--order_id--reviewable-items">Articles livrés de la commande encore sans avis.</h2>
...
<span id="example-requests-GETapi-v1-orders--order_id--reviewable-items">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost:8000/api/v1/orders/16/reviewable-items" \
    --header "Authorization: Bearer {YOUR_AUTH_KEY}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost:8000/api/v1/orders/16/reviewable-items"
);
...
<span id="example-responses-GETapi-v1-orders--order_id--reviewable-items">
            <blockquote>
            <p>Example response (401):</p>
        </blockquote>
                <details class="annotation">
...
<span id="execution-results-GETapi-v1-orders--order_id--reviewable-items" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-v1-orders--order_id--reviewable-items"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-v1-orders--order_id--reviewable-items"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-v1-orders--order_id--reviewable-items" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-v1-orders--order_id--reviewable-items">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-v1-orders--order_id--reviewable-items" data-method="GET"
      data-path="api/v1/orders/{order_id}/reviewable-items"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-v1-orders--order_id--reviewable-items', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-v1-orders--order_id--reviewable-items"
                    onclick="tryItOut('GETapi-v1-orders--order_id--reviewable-items');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-v1-orders--order_id--reviewable-items"
                    onclick="cancelTryOut('GETapi-v1-orders--order_id--reviewable-items');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-v1-orders--order_id--reviewable-items"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-green">GET</small>
            <b><code>api/v1/orders/{order_id}/reviewable-items</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Authorization</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="GETapi-v1-orders--order_id--reviewable-items"
               value="Bearer {YOUR_AUTH_KEY}"
               data-component="header">
    <br>
<p>Example: <code>Bearer {YOUR_AUTH_KEY}</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-v1-orders--order_id--reviewable-items"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-v1-orders--order_id--reviewable-items"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="order_id"                data-endpoint="GETapi-v1-orders--order_id--reviewable-items"
               value="16"
               data-component="url">
    <br>
<p>The ID of the order. Example: <code>16</code></p>
                    ...
                    <h2 id="avis-POSTapi-v1-orders--order_id--items--orderItem_id--reviews">Crée un avis pour un article de commande livré.</h2>
...
<span id="example-requests-POSTapi-v1-orders--order_id--items--orderItem_id--reviews">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request POST \
    "http://localhost:8000/api/v1/orders/16/items/16/reviews" \
    --header "Authorization: Bearer {YOUR_AUTH_KEY}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
...
<span id="example-responses-POSTapi-v1-orders--order_id--items--orderItem_id--reviews">
</span>
<span id="execution-results-POSTapi-v1-orders--order_id--items--orderItem_id--reviews" hidden>
    <blockquote>Received response<span
                id="execution-response-status-POSTapi-v1-orders--order_id--items--orderItem_id--reviews"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-POSTapi-v1-orders--order_id--items--orderItem_id--reviews"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-POSTapi-v1-orders--order_id--items--orderItem_id--reviews" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-POSTapi-v1-orders--order_id--items--orderItem_id--reviews">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-POSTapi-v1-orders--order_id--items--orderItem_id--reviews" data-method="POST"
      data-path="api/v1/orders/{order_id}/items/{orderItem_id}/reviews"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('POSTapi-v1-orders--order_id--items--orderItem_id--reviews', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-POSTapi-v1-orders--order_id--items--orderItem_id--reviews"
                    onclick="tryItOut('POSTapi-v1-orders--order_id--items--orderItem_id--reviews');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-v1-orders--order_id--items--orderItem_id--reviews"
                    onclick="cancelTryOut('POSTapi-v1-orders--order_id--items--orderItem_id--reviews');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-POSTapi-v1-orders--order_id--items--orderItem_id--reviews"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-black">POST</small>
            <b><code>api/v1/orders/{order_id}/items/{orderItem_id}/reviews</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Authorization</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="POSTapi-v1-orders--order_id--items--orderItem_id--reviews"
               value="Bearer {YOUR_AUTH_KEY}"
               data-component="header">
    <br>
<p>Example: <code>Bearer {YOUR_AUTH_KEY}</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="POSTapi-v1-orders--order_id--items--orderItem_id--reviews"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="POSTapi-v1-orders--order_id--items--orderItem_id--reviews"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="order_id"                data-endpoint="POSTapi-v1-orders--order_id--items--orderItem_id--reviews"
               value="16"
               data-component="url">
    <br>
<p>The ID of the order. Example: <code>16</code></p>
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="orderItem_id"                data-endpoint="POSTapi-v1-orders--order_id--items--orderItem_id--reviews"
               value="16"
               data-component="url">
    <br>
<p>The ID of the orderItem. Example: <code>16</code></p>
            </div>
                            <h4 class="fancy-heading-panel"><b>Body Parameters</b></h4>
        <div style=" padding-left: 28px;  clear: unset;">
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="rating"                data-endpoint="POSTapi-v1-orders--order_id--items--orderItem_id--reviews"
               value="5"
               data-component="body">
    <br>
<p>Note de 1 à 5 étoiles. Must be at least 1. Must not be greater than 5. Example: <code>5</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="comment"                data-endpoint="POSTapi-v1-orders--order_id--items--orderItem_id--reviews"
               value="Produit conforme à la description, livraison rapide."
               data-component="body">
    <br>
<p>Commentaire optionnel (max. 2000 caractères). Must not be greater than 2000 characters. Example: <code>Produit conforme à la description, livraison rapide.</code></p>
        </div>
        </form>

                                <h2 id="avis-gestion">Gestion</h2>
                                                    <h2 id="avis-PATCHapi-v1-reviews--id-">Met à jour un avis du client connecté.</h2>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request PATCH \
    "http://localhost:8000/api/v1/reviews/16" \
    --header "Authorization: Bearer {YOUR_AUTH_KEY}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
    \"rating\": 4,
    \"comment\": \"Très satisfait après utilisation.\"
}"
</code></pre></div>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="PATCHapi-v1-reviews--id-"
               value="Bearer {YOUR_AUTH_KEY}"
               data-component="header">
    <br>
<p>Example: <code>Bearer {YOUR_AUTH_KEY}</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Nouvelle note de 1 à 5 étoiles. Must be at least 1. Must not be greater than 5. Example: <code>4</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>comment</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="comment"                data-endpoint="PATCHapi-v1-reviews--id-"
               value="Très satisfait après utilisation."
               data-component="body">
    <br>
<p>Commentaire mis à jour (max. 2000 caractères). Must not be greater than 2000 characters. Example: <code>Très satisfait après utilisation.</code></p>
        </div>
        </form>

                    <h2 id="avis-DELETEapi-v1-reviews--id-">Supprime un avis du client connecté.</h2>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="DELETEapi-v1-reviews--id-"
               value="Bearer {YOUR_AUTH_KEY}"
               data-component="header">
    <br>
<p>Example: <code>Bearer {YOUR_AUTH_KEY}</code></p>
