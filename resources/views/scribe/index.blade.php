...
<div class="bash-example">
    ...
    --form "logo=@/tmp/phph1c95bke9l4k5flMmfK" </code></pre></div>
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Le fichier image du logo (Max 2Mo). Must be a file. Must not be greater than 2048 kilobytes. Example: <code>/tmp/phph1c95bke9l4k5flMmfK</code></p>
        </div>
        </form>
...
<div class="bash-example">
    ...
    --form "company_name=Madina SARL"\
    --form "vat_number=RC-CON-2024-B-1234"\
    --form "logo=@/tmp/phpcnalb3g0il9d3ckcNnK" </code></pre></div>
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Le fichier image du logo (Max 2Mo). Must be a file. Must not be greater than 2048 kilobytes. Example: <code>/tmp/phpcnalb3g0il9d3ckcNnK</code></p>
        </div>
        </form>
